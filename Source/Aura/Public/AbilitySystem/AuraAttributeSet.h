...
private:
	...
	void ShowFloatingText(const FEffectProperties& EffectProperties, float Damage, bool bBlockedHit, bool bCriticalHit);
	...
	static void Debuff(const FEffectProperties& EffectProperties);
